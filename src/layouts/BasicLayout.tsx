...
import { IconBell, IconHelpCircle, IconBytedanceLogo, IconHome, IconHistogram,
	IconLive, IconSetting } from '@douyinfe/semi-icons';

const BasicLayout:React.FC<React.PropsWithChildren<{}>> =  ( { children }) => {
	const { Header, Footer, Sider, Content } = Layout;
	return (
		<Layout className='app-layout-sider' style={{ border: '1px solid var(--semi-color-border)' }}>
